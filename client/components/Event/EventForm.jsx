                ...
                <Col>
                    ...
                    <Form>
                        ...
                        <Form.Group controlId="eventStartDate">
                            ...
                            <DateRangePicker onApply={this.startDateEvent} singleDatePicker><input className="form-control" value = {this.state.startDate} required></input></DateRangePicker>
                        </Form.Group>

                        <Form.Group controlId="eventEndDate">
                            <Form.Label className="label-text">Pabaigos data:</Form.Label>
                            <DateRangePicker onApply={this.endDateEvent} singleDatePicker><input className="form-control" value = {this.state.endDate} required></input></DateRangePicker>
                        </Form.Group>
