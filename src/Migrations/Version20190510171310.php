 ...
 */
final class Version20190510171310 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE job DROP INDEX UNIQ_FBD8E0F85FA33B08, ADD INDEX IDX_FBD8E0F85FA33B08 (job_type_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE organisation_id organisation_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE job DROP INDEX IDX_FBD8E0F85FA33B08, ADD UNIQUE INDEX UNIQ_FBD8E0F85FA33B08 (job_type_id)');
        $this->addSql('ALTER TABLE job CHANGE volunteer_id volunteer_id INT DEFAULT NULL, CHANGE job_type_id job_type_id INT DEFAULT NULL');
